...
Complexe::Complexe()    //Methode1: la definition du constructeur sans parametres
{
	this->Re = 0.0;
	this->Im = 0.0;
	nbre_instance++;
...
Complexe::Complexe(double Re, double Im)  // Methode2: la definition du constructeur avec parametres
{
...
Complexe::Complexe(const Complexe &z) //Methode3: la definition du constructeur de recopie
{
	this->Re = z.Re;
	this->Im = z.Im;
	nbre_instance++;
